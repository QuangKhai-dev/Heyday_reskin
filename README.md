...
```
cd existing_repo
git remote add origin http://gitlab.ebizworldsolutions.com/root/heydaylandingpage.git
git branch -M master
...
- [ ] [Set up project integrations](http://gitlab.ebizworldsolutions.com/root/heydaylandingpage/-/settings/integrations)
